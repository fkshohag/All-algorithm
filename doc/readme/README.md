...
33 | 1135           | Problem: [Connecting Cities With Minimum Cost](https://leetcode.com/problems/connecting-cities-with-minimum-cost/description/) <br/>Solution: [C++](../../Online-judge/leetcode/connecting-cities-with-minimum-cost.cpp)                                                                                                                  | MST, Kruskal's, Disjoint union set | Leetcode
34 | 1584           | Problem: [Min Cost to Connect All Points](https://leetcode.com/problems/min-cost-to-connect-all-points/description/) <br/>Solution: [C++](../../Online-judge/leetcode/min-cost-to-connect-all-points.cpp)                                                                                                                  | MST, Kruskal's, Disjoint union set | Leetcode
